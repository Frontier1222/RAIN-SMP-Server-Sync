...
export function isRestrictedUsableBlock(blockId) {
    ...
    // Anvils + Tinkers stations must stay usable for § / & item renames and repairs.
    if (isClaimWorkstationBlock(id)) {
        return !(id.includes("anvil") || isTinkersWorkstationBlock(id));
    }
