...
export function onPlayerSpawn(ev) {
  ...
  const dropped = snap
    ? dropPlayerInventoryAtLocation(player, snap.dimId, snap.location)
    : dropPlayerInventoryAtLocation(player, player.dimension.id, player.location);
