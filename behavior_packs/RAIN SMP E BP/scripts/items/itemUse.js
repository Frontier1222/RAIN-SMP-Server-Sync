...
world.afterEvents.itemUse.subscribe( data => {
    ...
    if (itemStack.typeId == "viberater:legendary_dart_gun") {
        ...
        const projectile = player.dimension.spawnEntity('viberater:legendary_dart_projectile', {x:hl.x+vd.x, y:hl.y+vd.y, z:hl.z+vd.z})
    ...
    if (itemStack.typeId == "viberater:rare_dart_gun") {
        ...
        const hl = player.getHeadLocation()
        const vd = player.getViewDirection()
        const projectile = player.dimension.spawnEntity('viberater:rare_dart_projectile', {x:hl.x+vd.x, y:hl.y+vd.y, z:hl.z+vd.z})
        projectile.getComponent('projectile').shoot({x:4*vd.x, y:4*vd.y, z:4*vd.z})
