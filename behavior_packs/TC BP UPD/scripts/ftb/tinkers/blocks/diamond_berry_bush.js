...
const stateProgression = [
    ...
    },
    {
        ...
        returnItem: null,
        sound: "random.pop",
        lootTable: "ftb/tinkers/berries/diamond_berry_half",
    },
    {
        condition: 3,
        ...
        returnItem: null,
        sound: "random.pop",
        lootTable: "ftb/tinkers/berries/diamond_berry_full",
    },
    {
        condition: 3,
        item: "minecraft:bone_meal",
...
// ========== COMPONENT ==========
class DiamondBerryBushComponent {
    constructor() {
                ...
                for (const player of players) {
                    ...
                    if (Math.floor(loc.x) === block.location.x &&
                        ...
                        try {
                            ...
                            console.warn(`[diamondBerryBush] Failed to damage player:`, e);
                        }
                    }
                }
            }
...
function runLootTableAt(player, lootTable, location) {
    ...
    try {
        ...
        console.warn(`[diamondBerryBush] Failed to run loot table '${lootTable}':`, err);
    }
}

export { DiamondBerryBushComponent };
