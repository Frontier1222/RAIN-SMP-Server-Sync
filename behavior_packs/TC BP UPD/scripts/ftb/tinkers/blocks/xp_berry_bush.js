...
const stateProgression = [
    ...
    },
    {
        ...
        sound: "item.bone_meal.use",
        particles: ["minecraft:crop_growth_emitter"],
        lootTable: "ftb/tinkers/berries/xp_berry_half",
    },
    {
        condition: 3,
        ...
        returnItem: null,
        sound: "random.pop",
        lootTable: "ftb/tinkers/berries/xp_berry_full",
    },
    {
        condition: 3,
        item: "minecraft:bone_meal",
                ...
                for (const player of players) {
                    ...
                    if (Math.floor(loc.x) === block.location.x &&
                        ...
                        try {
                            ...
                            console.warn(`[xpBerryBush] Failed to damage player:`, e);
                        }
                    }
                }
            }
...
function runLootTableAt(player, lootTable, location) {
    ...
    try {
        ...
        console.warn(`[xpBerryBush] Failed to run loot table '${lootTable}':`, err);
    }
}

export { XpBerryBushComponent };
